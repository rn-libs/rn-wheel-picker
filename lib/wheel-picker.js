...
export class RnWheelPicker extends React.Component {
  constructor(props) {
    super(props)
    ...
    this.state = {
      ...
      selectedIndex: props.data[props.selectedIndex] ? props.selectedIndex + 1 : 0,
    }
  }
  ...
  getData = (optionsData) => {
    ...
    return this.createEmptyArray(optionsCount / 2)
      .concat(optionsData.concat(this.createEmptyArray(optionsCount / 2)))
  }
  ...
  selectOption = (event) => {
    ...
    if (this.props.onValueChange) {
      this.props.onValueChange(this.data[selectedIndexWithEmptyBlock], selectedIndex)
    }
  }
  ...
  render() {
    ...
    return (
      <View
        style={[
          { height: optionHeight * optionsCount, width: optionsWrapperWidth, backgroundColor: wrapperBackground },
          styles.container,
        ]}
      >
        <View
